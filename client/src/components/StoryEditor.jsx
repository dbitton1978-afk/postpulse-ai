...
export default function App() {
  ...
  function handlePublishOption(platformName) {
    setPublishMenuOpen(false);
    alert(`${platformName}\n\n${t.publishComingSoon}`);
  }
          ...
          <section className="panel">
            ...
            {result && result.type === "build" ? (
              <div className="result-wrap">
                ...
                <div className="publish-menu-wrap" ref={publishMenuRef}>
                  <button
                    type="button"
                  ...
                  {publishMenuOpen ? (
                    <div className="publish-menu">
                      <button
                        ...
                        onClick={() => handlePublishOption(t.publishToInstagram)}
                      >
                      ...
                      <button
                        type="button"
                        className="publish-menu-item"
                        onClick={() => handlePublishOption(t.publishToFacebook)}
                      >
                        {t.publishToFacebook}
                      </button>
                      ...
                      <button
                        type="button"
                        className="publish-menu-item"
                        onClick={() => handlePublishOption(t.publishToLinkedIn)}
                      >
                        {t.publishToLinkedIn}
                      </button>
                      ...
                      <button
                        type="button"
                        className="publish-menu-item"
                        onClick={() => handlePublishOption(t.publishToTikTok)}
                      >
                        {t.publishToTikTok}
                      </button>
                    </div>
